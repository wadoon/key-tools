...
dependencies {
    ...
    plugin("com.fasterxml.jackson.core:jackson-databind:2.18.0")
    plugin("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.18.0")
    plugin("com.fasterxml.jackson.datatype:jackson-datatype-jdk8:2.18.0")
