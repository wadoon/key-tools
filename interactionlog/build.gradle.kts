...
dependencies {
    ...
    plugin("com.fasterxml.jackson.core:jackson-databind:2.16.2")
    plugin("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.16.2")
    plugin("com.fasterxml.jackson.datatype:jackson-datatype-jdk8:2.16.2")
